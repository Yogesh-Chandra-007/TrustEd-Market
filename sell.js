...
function setupFormSubmission() {
  ...
  sellForm.addEventListener('submit', async function(e) {
    ...
    try {
      ...
      if (!userSnapshot.exists()) throw new Error("User data not found. Complete your profile first.");
      ...
      const productData = {
        ...
        sellerName: userData.name || 'Unknown Seller', // Use standard `name`
      ...
      // Save product under user's listings safely
